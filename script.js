...
function openGlobalUserModal(userId) {
    ...
    body.innerHTML = `
        <div class="ticket-container">
            <div class="ticket-punch-hole left"></div>
            <div class="ticket-punch-hole right"></div>
            <div class="details-header">
                <button class="close-modal-btn">&times;</button>
            </div>
            <div class="user-profile-cover" style="height: 100px;"></div>
            <div class="details-profile" style="margin-top:-40px; padding-bottom:20px;">
            ...
            <div style="padding: 10px 24px; border-bottom: 2px dashed #eee; background: #fcfcfc;"></div>
            <div style="padding: 20px 24px; height: 350px; overflow-y: auto; background: white; pointer-events: auto;">
